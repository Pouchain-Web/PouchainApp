    ...
    <div class="admin-layout">
        <aside class="sidebar" style="${isFullscreenTab ? 'display: none !important;' : ''}">
            ...
            <nav id="admin-nav" style="visibility: hidden;">
                ...
                <a href="#" onclick="document.getElementById('admin-global-search').value = ''; renderAdminPlanningPrevisionnel()" id="nav-planning-previsionnel">📊 Maintenance Prévisionnelle</a>
